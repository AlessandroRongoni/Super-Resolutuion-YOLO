...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        self.stride = stride
        if hr_input== False:
            self.img_path = 'C:\\Users\\serda\\Desktop\\UNI\\Computer Vision And Deep Learning\\Progetto esame\\SuperYOLO-detection_armi\\dataset\\DETECTION\\images\\' #zjq the path for 512*512 images
        else:
            self.img_path = 'C:\\Users\\serda\\Desktop\\UNI\\Computer Vision And Deep Learning\\Progetto esame\\SuperYOLO-detection_armi\\dataset\\DETECTION_1280\\images\\' #zjq the path for 1024*1024 images
